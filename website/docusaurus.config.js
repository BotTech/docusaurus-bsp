...
const config = {
  ...
  projectName: 'docusaurus-bsp-plugin', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/BotTech/docusaurus-bsp-plugin',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Issues',
                href: 'https://github.com/BotTech/docusaurus-bsp-plugin/issues',
              },
              {
                label: 'Discussions',
                href: 'https://github.com/BotTech/docusaurus-bsp-plugin/discussions',
              },
            ],
          },
          {
